...
export default function ResumeBuilder() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Left Panel - Form */}
      <div className="w-1/2 bg-white flex flex-col rounded-r-3xl shadow-lg">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <button 
              onClick={() => alert('Back to portfolio')}
          ...
          {/* Steps Navigation - Non-scrollable */}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl flex items-center justify-center">
              <StepIcon className="text-blue-600" size={20} />
            </div>
            <div>
          ...
          <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm text-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm text-gray-600 bg-gray-50"
                    />
                  </div>
                  <div>
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                {resumeData.workExperience.map((work, index) => (
                  <div key={index} className="border border-gray-200 rounded-2xl p-4 space-y-3 bg-gray-50">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-gray-800 text-sm">Experience {index + 1}</h3>
                      <button
                        onClick={() => removeWorkExperience(index)}
                        className="text-red-600 hover:text-red-700 p-1 hover:bg-red-50 rounded-lg"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-xl text-sm text-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-2xl text-gray-600 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 transition-all w-full justify-center text-sm font-medium"
                >
                  <Plus size={16} />
                  Add Work Experience
                </button>
            ...
            {currentStep === 4 && (
              <div className="space-y-4">
                {resumeData.skills.map((skill, index) => (
                  <div key={index} className="border border-gray-200 rounded-2xl p-4 space-y-3 bg-gray-50">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-gray-800 text-sm">Skill {index + 1}</h3>
                      <button
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-gray-700 mb-1">Proficiency</label>
                        <select
                ...
                {resumeData.projects.map((project, index) => (
                  <div key={index} className="border border-gray-200 rounded-2xl p-4 space-y-3 bg-gray-50">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-xs font-semibold text-gray-700 mb-1">GitHub Link</label>
                          <input
                            type="url"
                  ...
                  <div key={index} className="border border-green-200 bg-green-50 rounded-2xl p-4">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-blue-600 font-medium text-xs mb-1">{cert.achievement}</p>
            ...
            {currentStep === 7 && (
              <div className="space-y-6">
                {/* Languages */}
                <div>
                  <h3 className="font-semibold text-gray-800 mb-3 text-sm">Languages</h3>
                  <div className="space-y-3">
                    {resumeData.additionalInfo.languages.map((lang, index) => (
                      <div key={index} className="border border-gray-200 rounded-2xl p-4 space-y-3 bg-gray-50">
                        <div className="flex items-center justify-between">
                          <h4 className="font-semibold text-gray-800 text-xs">Language {index + 1}</h4>
                          <button
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {resumeData.additionalInfo.interests.map((interest, index) => (
                      <div key={index} className="border border-gray-200 rounded-2xl p-4 space-y-3 bg-gray-50">
                        <div className="flex items-center justify-between">
                          <h4 className="font-semibold text-gray-800 text-xs">Interest {index + 1}</h4>
                          <button
        ...
        {/* Navigation Buttons */}
        <div className="p-6 border-t border-gray-200 bg-white rounded-br-3xl">
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-200 transition-all"
            >
              <Save size={16} />
              Save
            </button>
            ...
            {currentStep < steps.length - 1 ? (
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl text-sm font-semibold hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg"
              >
                Next
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl text-sm font-semibold hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg"
              >
                <Download size={16} />
                Download PDF
              </button>
      ...
      <div className="w-1/2 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center p-8 overflow-hidden">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[210mm] h-[297mm] overflow-y-auto p-8">
          {/* Resume Header */}
          <div className="text-center mb-6 pb-4 border-b-2 border-gray-300">
            ...
            {(resumeData.contactInfo.linkedin || resumeData.contactInfo.github || resumeData.contactInfo.portfolio) && (
              <div className="flex items-center justify-center gap-3 text-sm text-blue-600 mt-2">
                ...
                <div key={index} className="mb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      ...
                      {edu.cgpa && <p className="text-sm font-semibold text-gray-800">CGPA: {edu.cgpa}</p>}
                    </div>
                  </div>
                </div>
              ))}
              ...
              {resumeData.workExperience.map((work, index) => (
                <div key={index} className="mb-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h3 className="font-semibold text-gray-800 text-sm">{work.role}</h3>
              ...
              {resumeData.certifications.map((cert, index) => (
                <div key={index} className="mb-3 flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-blue-600 font-medium">{cert.achievement}</p>
